...
def seedruns(user_id, number_of_runs_to_add, starting_date, run_id_start):
	...
	for run in range(number_of_runs_to_add - 1):
		...
		current_run = model.Run(user_id = user_id, id = run_id, date_run = date_run, zipcode = zipcode, approx_dist = approx_dist, approx_time = approx_time, commit_date = commit_date)
